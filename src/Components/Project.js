...
const Project = () => {
  return (
    <div className="outer-div-projects" style={{ color: "white"}}>
      <Typography variant="div" className="text-intro">
        {" "}
        Projects{" "}
      ...
      <Grid
        ...
        alignItems="center"
      >
        <Grid className="leftGrid childrenGrid" sm={11} md={5}>
          <Card>
            <MediaCard
        ...
        <Grid md={1}></Grid>
        <Grid className="rightGrid childrenGrid " sm={11} md={5}>
          <Card>
            <MediaCard
